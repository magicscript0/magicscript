    ...
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-10 sm:px-6">
      ...
      <div className="relative w-full max-w-[420px] page-enter">
        <div className="mb-7 flex flex-col items-center text-center">
          ...
          <h1 className="mt-2 text-3xl font-semibold tracking-[-.05em] text-slate-100">Apple of Fortune</h1>
        ...
        <form onSubmit={handleSubmit} noValidate className="panel p-5 sm:p-7">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="mt-1.5 text-[11px] text-slate-600">9–11 digits, numbers only.</p>
            </div>
            <div>
          ...
          <button type="submit" disabled={checking} aria-label={checking ? 'Checking access' : 'Enter game'} className="btn-primary mt-5 min-h-12 w-full text-sm">
            {checking ? (
              <>
        ...
        <p className="mt-5 text-center text-[10px] font-semibold uppercase tracking-[.16em] text-slate-700">Demo experience · no real-money play</p>
      </div>
    </main>
  )
}
